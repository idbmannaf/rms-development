...
<head>
    ...
    <style>
        ...
        .nav-sidebar .nav-item > .nav-link:hover {
            color: #fff !important;;
            background: #3670d4 !important;
        }

        .nav-pills .nav-link.active, .nav-pills .show > .nav-link {
            color: #fff !important;
            background-color: #3670d4 !important;
        }
...
<!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('company.home',$company)}}" > <i class="fas fa-home"></i> Home</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{route('company-infos.edit',$company)}}">
                        <i class="fas fa-cog"></i> Edit Company
                    </a>
...
<!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('company.change-password')}}" id="change-password" method="POST">
                        @csrf
    ...
    <aside class="main-sidebar elevation-4" style="background-color: #096ba6">
        <!-- Brand Logo -->
        {{--        <img src="{{asset('/')}}assets/admin/dist/img/user2-160x160.jpg" alt="Logo" class="img-fluid" style="cursor: pointer; width: 100%;">--}}
        <a href="{{route('company.home',$company)}}" class="">
            <img src="{{asset($company->logo)}}" alt="Logo" class="img-fluid company_logo"
                 style="opacity: 1;">
...
<script>
    ...
    Toastify({
        text: "{{ Session::get('success') }}", duration: 2000,
        style: {background: '#3e935c'},
    }).showToast();

    @elseif(Session::has('warning'))
    Toastify({
        text: "{{ Session::get('warning') }}", duration: 2000,
    ...
    Toastify({
        text: "{{ Session::get('error') }}", duration: 2000,
        // style: { background: "linear-gradient(to right, #00b09b, #96c93d)",
        //     color:'#f51804'
        // }
...
<script>
    $(document).on('input', '#old_password', function () {
        ...
        $.ajax({
            url: "{{route('company.password-verify')}}",
            type: "GET",
            data: {
